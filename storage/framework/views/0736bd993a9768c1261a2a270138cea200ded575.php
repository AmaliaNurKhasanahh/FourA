                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="product_code" value="<?php echo e($item->product_code); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Nama</label>
                                        ...
                                        <select class="form-control" name="category_id">
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($category->id); ?>"
                                                    <?php echo e(($item->category_id || old('category_id')) == $category->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control currency" name="stock" value="<?php echo e($item->stock); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control currency" name="purchase_price" value="<?php echo e($item->purchase_price); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control currency" name="selling_price" value="<?php echo e($item->selling_price); ?>">
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PENGKODEAN\LaraPOS\resources\views/pages/product/edit.blade.php ENDPATH**/ ?>