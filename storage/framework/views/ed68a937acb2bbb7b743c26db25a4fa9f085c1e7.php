<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <a href="<?php echo e(route('home')); ?>" class="nav-link"><i class="ion-android-home"></i> <span>Beranda</span></a>
      </li>
      ...
      <?php if(Auth::user()->roles == 'admin'): ?>
        ...
        <li class="<?php echo e((Request::url() === route('user.index')) ? 'active' : ''); ?>">
          <a class="nav-link" href="<?php echo e(route('user.index')); ?>"><i class="ion-android-person"></i> <span>Pengguna</span></a>
        </li>
        <li class="<?php echo e((Request::url() === route('product.index')
          ...
          <li class="<?php echo e((Request::url() === route('customer.index')) ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('customer.index')); ?>"><i class="ion-person-stalker"></i> <span>Pelanggan</span></a>
          </li>
...
<?php /**PATH C:\PENGKODEAN\LaraPOS\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>