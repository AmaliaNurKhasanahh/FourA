        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?php echo e(route('coupon.create')); ?>" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(date('d-m-Y', strtotime($item->expired))); ?></td>
                                        <td>
                                            <span class="badge badge-<?php echo e($item->status == 1 ? 'success' : 'danger'); ?>">
                                                <?php echo e($item->status == 1 ? 'Aktif' : 'Tidak Aktif'); ?>

                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <a href="<?php echo e(route('coupon.edit', $item->id)); ?>" class="btn btn-success btn-icon icon-left">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PENGKODEAN\LaraPOS\resources\views/pages/coupon/index.blade.php ENDPATH**/ ?>