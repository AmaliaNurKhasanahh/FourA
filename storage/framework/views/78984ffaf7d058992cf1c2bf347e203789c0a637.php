        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?php echo e(route('product-category.create')); ?>" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <a href="<?php echo e(route('product-category.edit', $item->id)); ?>" class="btn btn-success btn-icon icon-left">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <form action="<?php echo e(route('product-category.destroy', $item->id)); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PENGKODEAN\LaraPOS\resources\views/pages/product/category/index.blade.php ENDPATH**/ ?>