    ...
    <?php echo $__env->yieldContent('addon-script'); ?>
    ...
    <footer class="main-footer">
        <div class="footer-left">
            Copyright &copy; 2023 <div class="bullet"></div> Design By <a href="https://nauval.in/">FourA</a>
        </div>
        <div class="footer-right">
            Dibuat dengan <i class="fas fa-heart text-danger"></i> oleh <a href="https://FourA.id" target="_blank" rel="noopener noreferrer">FourA</a>
        </div>
    </footer><?php /**PATH C:\PENGKODEAN\LaraPOS\resources\views/layouts/footer.blade.php ENDPATH**/ ?>