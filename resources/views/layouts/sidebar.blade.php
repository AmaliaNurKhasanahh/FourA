    ...
    <aside id="sidebar-wrapper">
      ...
      @if (Auth::user()->roles == 'admin')
        ...
        <li class="{{ (Request::url() === route('user.index')) ? 'active' : '' }}">
          <a class="nav-link" href="{{ route('user.index') }}"><i class="ion-android-person"></i> <span>Pengguna</span></a>
        </li>
        <li class="{{ (Request::url() === route('product.index')
          ...
          <li class="{{ (Request::url() === route('companyProfile.index')) ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('companyProfile.index') }}"><i class="ion-android-settings"></i> <span>Profil Perusahaan</span></a>
          </li>
